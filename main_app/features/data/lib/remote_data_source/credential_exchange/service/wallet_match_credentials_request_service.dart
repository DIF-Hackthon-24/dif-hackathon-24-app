...
class PostWalletMatchCredentialsServiceParams extends TaskParams {
  String? token;
  String? credentialsRequest;

  PostWalletMatchCredentialsServiceParams({
    required this.token,
...
class PostWalletMatchCredentialsRequestService extends BaseGraphQLService {
  @override
  ...
  RestRequest getRestRequest(TaskParams? params,
      {Map<String, dynamic>? paramsInMap}) {
    final parameters = params as PostWalletMatchCredentialsServiceParams;
