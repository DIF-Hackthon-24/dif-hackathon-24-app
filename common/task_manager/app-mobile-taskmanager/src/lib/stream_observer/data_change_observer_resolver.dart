    ...
    switch (type) {
        ...
        await Future.forEach(
          ...
          (dynamic key) async {
            ...
            if (!(_streamControllers.containsKey(key))) {
              final newStreamController = StreamController.broadcast();
      ...
      case DataNotifierTaskType.SET:
        await Future.forEach(
          ...
          (dynamic key) async {
            final keyData = key as MapEntry<String,dynamic>;
            if (_streamControllers.containsKey(keyData.key)) {
              final element = _streamControllers[keyData.key];
              element!.add({
